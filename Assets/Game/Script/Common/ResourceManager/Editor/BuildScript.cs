...
namespace AssetBundles
{
    public class BuildScript
    {
        ...
        public static void BuildAssetBundles(AssetBundleBuild[] builds, BuildAssetBundleOptions options = BuildAssetBundleOptions.None)
        {
            // Choose the output path according to the build target.
...
//            }
        ...
        public static void WriteServerURL()
        {
            ...
            string assetBundleManagerResourcesDirectory = "Assets/WGame/Resources";
