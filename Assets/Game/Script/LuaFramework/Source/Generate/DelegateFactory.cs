...
public class DelegateFactory
{
	...
	public static void Register()
	{
		...
		dict.Add(typeof(WGame.Cookie.CookieGetter), factory.WGame_Cookie_CookieGetter);
		dict.Add(typeof(WGame.Cookie.CookieSetter), factory.WGame_Cookie_CookieSetter);
		dict.Add(typeof(WGame.Cookie.IfNullGetter), factory.WGame_Cookie_IfNullGetter);
		dict.Add(typeof(WGame.Cookie.CookieSetListener), factory.WGame_Cookie_CookieSetListener);
		...
		DelegateTraits<WGame.Cookie.CookieGetter>.Init(factory.WGame_Cookie_CookieGetter);
		DelegateTraits<WGame.Cookie.CookieSetter>.Init(factory.WGame_Cookie_CookieSetter);
		DelegateTraits<WGame.Cookie.IfNullGetter>.Init(factory.WGame_Cookie_IfNullGetter);
		DelegateTraits<WGame.Cookie.CookieSetListener>.Init(factory.WGame_Cookie_CookieSetListener);
		...
		TypeTraits<WGame.Cookie.CookieGetter>.Init(factory.Check_WGame_Cookie_CookieGetter);
		TypeTraits<WGame.Cookie.CookieSetter>.Init(factory.Check_WGame_Cookie_CookieSetter);
		TypeTraits<WGame.Cookie.IfNullGetter>.Init(factory.Check_WGame_Cookie_IfNullGetter);
		TypeTraits<WGame.Cookie.CookieSetListener>.Init(factory.Check_WGame_Cookie_CookieSetListener);
		...
		StackTraits<WGame.Cookie.CookieGetter>.Push = factory.Push_WGame_Cookie_CookieGetter;
		StackTraits<WGame.Cookie.CookieSetter>.Push = factory.Push_WGame_Cookie_CookieSetter;
		StackTraits<WGame.Cookie.IfNullGetter>.Push = factory.Push_WGame_Cookie_IfNullGetter;
		StackTraits<WGame.Cookie.CookieSetListener>.Push = factory.Push_WGame_Cookie_CookieSetListener;
	...
	class WGame_Cookie_CookieGetter_Event : LuaDelegate
	{
		public WGame_Cookie_CookieGetter_Event(LuaFunction func) : base(func) { }
		public WGame_Cookie_CookieGetter_Event(LuaFunction func, LuaTable self) : base(func, self) { }
	...
	public WGame.Cookie.CookieGetter WGame_Cookie_CookieGetter(LuaFunction func, LuaTable self, bool flag)
	{
		if (func == null)
		{
			WGame.Cookie.CookieGetter fn = delegate(object param0) { return null; };
			return fn;
		}

		if(!flag)
		{
			WGame_Cookie_CookieGetter_Event target = new WGame_Cookie_CookieGetter_Event(func);
			WGame.Cookie.CookieGetter d = target.Call;
			target.method = d.Method;
			return d;
		}
		else
		{
			WGame_Cookie_CookieGetter_Event target = new WGame_Cookie_CookieGetter_Event(func, self);
			WGame.Cookie.CookieGetter d = target.CallWithSelf;
			target.method = d.Method;
			return d;
		}
	}

	bool Check_WGame_Cookie_CookieGetter(IntPtr L, int pos)
	{
		return TypeChecker.CheckDelegateType(typeof(WGame.Cookie.CookieGetter), L, pos);
	}

	void Push_WGame_Cookie_CookieGetter(IntPtr L, WGame.Cookie.CookieGetter o)
	{
		ToLua.Push(L, o);
	}

	class WGame_Cookie_CookieSetter_Event : LuaDelegate
	{
		public WGame_Cookie_CookieSetter_Event(LuaFunction func) : base(func) { }
		public WGame_Cookie_CookieSetter_Event(LuaFunction func, LuaTable self) : base(func, self) { }
	...
	public WGame.Cookie.CookieSetter WGame_Cookie_CookieSetter(LuaFunction func, LuaTable self, bool flag)
	{
		if (func == null)
		{
			WGame.Cookie.CookieSetter fn = delegate(string param0, object param1) { };
			return fn;
		}

		if(!flag)
		{
			WGame_Cookie_CookieSetter_Event target = new WGame_Cookie_CookieSetter_Event(func);
			WGame.Cookie.CookieSetter d = target.Call;
			target.method = d.Method;
			return d;
		}
		else
		{
			WGame_Cookie_CookieSetter_Event target = new WGame_Cookie_CookieSetter_Event(func, self);
			WGame.Cookie.CookieSetter d = target.CallWithSelf;
			target.method = d.Method;
			return d;
		}
	}

	bool Check_WGame_Cookie_CookieSetter(IntPtr L, int pos)
	{
		return TypeChecker.CheckDelegateType(typeof(WGame.Cookie.CookieSetter), L, pos);
	}

	void Push_WGame_Cookie_CookieSetter(IntPtr L, WGame.Cookie.CookieSetter o)
	{
		ToLua.Push(L, o);
	}

	class WGame_Cookie_IfNullGetter_Event : LuaDelegate
	{
		public WGame_Cookie_IfNullGetter_Event(LuaFunction func) : base(func) { }
		public WGame_Cookie_IfNullGetter_Event(LuaFunction func, LuaTable self) : base(func, self) { }
	...
	bool Check_WGame_Cookie_IfNullGetter(IntPtr L, int pos)
	{
		return TypeChecker.CheckDelegateType(typeof(WGame.Cookie.IfNullGetter), L, pos);
	}
	...
	class WGame_Cookie_CookieSetListener_Event : LuaDelegate
	{
		public WGame_Cookie_CookieSetListener_Event(LuaFunction func) : base(func) { }
		public WGame_Cookie_CookieSetListener_Event(LuaFunction func, LuaTable self) : base(func, self) { }
	...
	bool Check_WGame_Cookie_CookieSetListener(IntPtr L, int pos)
	{
		return TypeChecker.CheckDelegateType(typeof(WGame.Cookie.CookieSetListener), L, pos);
	}
